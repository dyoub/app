...
{
    public class UpdatePaymentsOfConfirmedRentContractContext : TenantContext
    {
        ...
        public UpdatePaymentsOfConfirmedRentContractContext() : base(1, DbConnectionFactory.CreateTransient())
        {
            Tenant tenant = Tenants.Add(TenantFactory.Tenant());
            Store store = Stores.Add(StoreFactory.Store(tenant));
            PaymentMethod paymentMethod = PaymentMethods.Add(PaymentMethodFactory.PaymentMethod(tenant));
            RentContract rentContract = RentContracts.Add(RentContractFactory.ConfirmedRentContract(store));
        ...
        public bool RentPaymentsNotChanged()
        {
