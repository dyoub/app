...
{
    public class ListRentPaymentsContext : TenantContext
    {
        public RentContract RentContract { get; private set; }

        public ListRentPaymentsContext() : base(1, DbConnectionFactory.CreateTransient())
        {
            ...
            RentPayments.Add(RentPaymentFactory.RentPayment(RentContract, paymentMethod));
