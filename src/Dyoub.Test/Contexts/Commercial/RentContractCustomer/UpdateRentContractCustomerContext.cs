...
{
    public class UpdateRentContractCustomerContext : TenantContext
    {
        ...
        public UpdateRentContractCustomerContext() : base(1, DbConnectionFactory.CreateTransient())
        {
        ...
        public bool RentContractWasUpdated()
        {
            ...
            return RentContract.Customer.Id == AnotherCustomer.Id;
        }
    }
}
