...
{
    public class UpdateCustomerToConfirmedSaleOrderContext : TenantContext
    {
        ...
        public UpdateCustomerToConfirmedSaleOrderContext() : base(1, DbConnectionFactory.CreateTransient())
        {
            Tenant tenant = Tenants.Add(TenantFactory.Tenant());
            Customer customer = Customers.Add(CustomerFactory.Customer(tenant));
            Store store = Stores.Add(StoreFactory.Store(tenant));
            
            SaleOrder = SaleOrders.Add(SaleOrderFactory.ConfirmedSaleOrder(store, customer));
        ...
        public bool SaleOrderWasNotChanged()
        {
            ...
            return SaleOrder.Customer.Id == original.Customer.Id;
        }
    }
}
