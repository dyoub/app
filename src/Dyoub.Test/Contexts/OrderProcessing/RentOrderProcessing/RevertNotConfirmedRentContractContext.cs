...
{
    public class RevertNotConfirmedRentContractContext : TenantContext
    {
        public RentContract RentContract { get; private set; }

        public RevertNotConfirmedRentContractContext() : base(1, DbConnectionFactory.CreateTransient())
        {
            ...
            RentPayment rentPayment = RentPayments.Add(RentPaymentFactory.RentPayment(RentContract, paymentMethod));
            RentIncomes.Add(RentIncomeFactory.RentIncome(rentPayment));
