...
{
    public class UpdatePaymentsOfConfirmedPurchaseOrderContext : TenantContext
    {
        private PurchasePayment original;

        public PurchasePayment PurchasePayment { get; private set; }

        public UpdatePaymentsOfConfirmedPurchaseOrderContext() : base(1, DbConnectionFactory.CreateTransient())
        {
        ...
        public bool PurchasePaymentsNotChanged()
        {
