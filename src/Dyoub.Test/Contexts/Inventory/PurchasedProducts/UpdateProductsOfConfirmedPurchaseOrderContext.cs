...
{
    public class UpdateItemsOfConfirmedPurchaseOrderContext : TenantContext
    {
        public PurchaseOrder PurchaseOrder { get; private set; }
        public Product Product { get; private set; }
        public Product AnotherProduct { get; private set; }

        public UpdateItemsOfConfirmedPurchaseOrderContext() : base(1, DbConnectionFactory.CreateTransient())
        {
